      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-base sm:text-lg text-oxford/70 leading-relaxed max-w-2xl">
            Layanan konsultasi metodologi dan pengolahan statistik kompleks untuk Skripsi, Tesis,
            Disertasi, dan Publikasi Jurnal. Ditangani secara eksklusif oleh pakar berlatar belakang
            Magister Ilmu Gizi Universitas Negeri Yogyakarta (UNY).
          </p>
